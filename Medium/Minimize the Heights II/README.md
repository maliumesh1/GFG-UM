...
<span class="wiseone-analysis-result wiseone-analysis-result-entity">Arr</span>[] = {1, 5, 8, 10}
...
<span class="wiseone-analysis-result wiseone-analysis-result-entity">Arr</span>[] = {3, 9, 12, 16, 20}
<strong>Output:</strong>
11
<strong>Explanation:</strong>
...
<p><span style="font-size: 18px;"><strong><span class="wiseone-analysis-result wiseone-analysis-result-entity">Expected Time</span> Complexity:</strong>&nbsp;O(N*logN)<br><strong>Expected Auxiliary Space:</strong>&nbsp;<span class="wiseone-analysis-result wiseone-analysis-result-entity">O(N)</span><br></span></p>
